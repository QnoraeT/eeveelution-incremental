...
function updateTearonq() {
    tmp.tearonqMemberCost = smoothPoly(D(player.tearonq.members), D(3), D(40), false).mul(10).add(20)
    tmp.tearonqMemberTarget = smoothPoly(Decimal.sub(player.tearonq.members, 20).div(10), D(3), D(40), true)
