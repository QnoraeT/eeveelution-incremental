(function (global, factory) {
    ...
    var DEFAULT_FROM_STRING_CACHE_SIZE = (1 << 15) - 1; // The default size of the LRU cache used to cache Decimal.fromString.
      ...
      _createClass(Decimal, [{
        ...
        value: function factorial() {
          if (this.mag < 0) {
            ...
            if (this.mag >= 0 && this.mag <= 170 && Number.isInteger(this.mag)) {
              return Decimal.fromNumber(FACTORIAL_LIST[this.mag])
            }
            return this.add(1).gamma();
          } else if (this.layer === 1) {
